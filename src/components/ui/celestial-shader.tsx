...
const CelestialBloomShader = () => {
    ...
    `;
      ...
      void main() {
        ...
        // Changed colors to black background with red bloom
        vec3 deepSpace = vec3(0.0, 0.0, 0.0); // Pure black
        vec3 nebula    = vec3(0.8, 0.1, 0.1); // Deep red
        vec3 star      = vec3(1.0, 0.3, 0.2); // Bright red-orange
